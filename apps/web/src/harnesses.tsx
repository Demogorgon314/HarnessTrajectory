 ...
 * Codex and Kimi paths are from lobe-icons (`@lobehub/icons-static-svg`,
 * MIT, (c) LobeHub). The marks themselves belong to Anthropic, OpenAI, and
 * Moonshot AI and identify their harnesses here.
 */
