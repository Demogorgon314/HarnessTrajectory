...
// purity. Driven through the real fold (driveTimeline / def.view).

import assert from './helpers/assert.ts'
import { describe, test } from 'vitest'
import { createTimelineState } from '../../src/fold/fold.ts'
import type { CostBucketTotals, SessionCostUsage, SurfaceNode } from '../../src/shared/types.ts'
import { assistantMessage, header, planMode, requestContext, toolCall, toolResult, userMessage } from './helpers/events.ts'
import { assertPlainJson, driveTimeline, timelineDef } from './helpers/drive.ts'
