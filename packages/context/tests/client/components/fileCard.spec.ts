...
function fileOp(seq: number, kind: FileOp['kind'], tool: string, over: Loose<FileOp> = {}): FileOp {
  return { seq, kind, tool, time: T0 + seq, err: false, added: 0, removed: 0, path: '', ...over } as FileOp
}
