...
// jsdom does not implement scrollIntoView; the client calls it when focusing
...
// so no spec ever reaches models.dev. Specs that need prices inject their own
// loader (resetModelPrices + setModelPricesLoader, see modelPrices.spec).
resetModelPrices()
