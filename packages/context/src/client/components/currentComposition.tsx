...
import type { LegendProps, StackedBarProps } from './stackedBar'

type LegendFn = (props: LegendProps) => ReactElement
...
export interface CurrentCompositionProps {
  ...
  /** PORT ADDITION — the composition part whose figure is a derived remainder. */
    ...
    return (
      <div className="lc-card">
        ...
        <StackedBar
          ...
          reserve={reserve}
        />
        <Legend parts={head.parts} hoverKey={props.hoverKey} onHoverKey={props.onHoverKey} derivedKey={props.derivedKey} />
      </div>
    )
  }
}
