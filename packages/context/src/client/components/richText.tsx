...
import { icons, MarkdownText, writeClipboard } from '@harness-trajectory/ui'
...
const Markdown = MarkdownText as unknown as (props: { text: string; labels?: MarkdownChrome }) => ReactElement
