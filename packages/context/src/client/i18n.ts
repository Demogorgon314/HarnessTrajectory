...
export const DICT_ZH: Record<string, string> = {
  ...
  'stats.peakContext': '峰值上下文',
  'stats.peakContextTip': '本会话发送过的最大 prompt，占上下文窗口的比例；窗口未知时显示 token 数。',
  'stats.duration': '总时长',
...
export const DICT_EN: Record<string, string> = {
  ...
  'stats.peakContext': 'Peak Context',
  'stats.peakContextTip': 'Largest prompt the session sent, as a share of the context window; the token count when the window is unknown.',
